...
// logg(__LINE__, "In DecisionDialog::SetupWindow()", "First approval",(long)AuthMsg.FirstApproval,0);
// logg(__LINE__, "In DecisionDialog::SetupWindow()", "Last Approval",(long)AuthMsg.LastApproval,0);
// logg(__LINE__, "In DecisionDialog::SetupWindow()", "Amt and sum",(long)AuthMsg.AmountApprovals, (int)AuthMsg.NumApprovals);
...
//   logg(__LINE__, "In DecisionDialog::SetupWindow() First approval",BufFirst,0,0);
   t=localtime( (time_t*)&ulLastApproval);
   sprintf(BufLast,"%02d/%02d/%02d",t->tm_mon+1,t->tm_mday,t->tm_year%100);
//   logg(__LINE__, "In DecisionDialog::SetupWindow() Last approval",BufLast,0,0);

   sprintf(szMsgBuf,"POS FILE - 1st- %s,   Last- %s,   # %d,   $ %ld",
