...
#define R3AGEREFERNUM1FROM 4049L
#define R3AGEREFERNUM1TO 4050L
#define R3AGEREFERNUM2FROM 4051L
#define R3AGEREFERNUM2TO 4052L
#define R3AGEREFERNUM3FROM 4053L
#define R3AGEREFERNUM3TO 4054L
#define R3AGEREFERAMT1FROM 4055L
#define R3AGEREFERAMT1TO 4056L
#define R3AGEREFERAMT2FROM 4057L
#define R3AGEREFERAMT2TO 4058L
#define R3AGEREFERAMT3FROM 4059L
#define R3AGEREFERAMT3TO 4060L
#define R3REFERNUM1FROM 4061L
#define R3REFERNUM1TO 4062L
#define R3REFERAMT1FROM 4063L
#define R3REFERAMT1TO 4064L
#define R3REFERNUM2FROM 4065L
#define R3REFERNUM2TO 4066L
#define R3REFERAMT2FROM 4067L
#define R3REFERAMT2TO 4068L
#define R3REFERNUM3FROM 4069L
#define R3REFERNUM3TO 4070L
#define R3REFERAMT3FROM 4071L
#define R3REFERAMT3TO 4072L
#define R3AGEOVRDAGE1 4073L
#define R3AGEOVRDNUM1FROM 4074L
#define R3AGEOVRDNUM1TO 4075L
#define R3AGEOVRDAMT1FROM 4076L
#define R3AGEOVRDAMT1TO 4077L
#define R3AGEOVRDAGE2 4078L
#define R3AGEOVRDNUM2FROM 4079L
#define R3AGEOVRDNUM2TO 4080L
#define R3AGEOVRDAMT2FROM 4081L
#define R3AGEOVRDAMT2TO 4082L
#define R3AGEOVRDAGE3 4083L
#define R3AGEOVRDNUM3FROM 4084L
#define R3AGEOVRDNUM3TO 4085L
#define R3AGEOVRDAMT3FROM 4086L
#define R3AGEOVRDAMT3TO 4087L
#define R3OVRDNUM1FROM 4088L
#define R3OVRDNUM1TO 4089L
#define R3OVRDAMT1FROM 4090L
#define R3OVRDAMT1TO 4091L
#define R3OVRDNUM2FROM 4092L
#define R3OVRDNUM2TO 4093L
#define R3OVRDAMT2FROM 4094L
#define R3OVRDAMT2TO 4095L
#define R3OVRDNUM3FROM 4096L
#define R3OVRDNUM3TO 4097L
#define R3OVRDAMT3FROM 4098L
#define R3OVRDAMT3TO 4099L
#define R4 4100L
#define R4ENABLE 4101L
#define R4DATETIME 4102L
#define R4PRODUCT 4103L
#define R4FWDDAYS1 4104L
#define R4FWDGAP1 4105L
#define R4FWDDAYS2 4106L
#define R4FWDGAP2 4107L
#define R4FWDDAYS3 4108L
#define R4FWDGAP3 4109L
#define R4BACKDAYS 4110L
#define R4BACKGAP 4111L
#define R5 4112L
#define R5ENABLE 4113L
#define R5DATETIME 4114L
#define R5PRODUCT 4115L
#define R5AMT 4116L
#define R6 4117L
#define R6ENABLE 4118L
#define R6DATETIME 4119L
#define R6PRODUCT 4120L
#define R6AMT 4121L
#define R6ACCUM 4122L
#define R7 4123L
#define R7ENABLE 4124L
#define R7DATETIME 4125L
#define R7PRODUCT 4126L
#define R7DAILYNUM 4127L
#define R7DAILYAMT 4128L
#define R7PER1DAYS 4129L
#define R7PER2DAYS 4130L
#define R7PER3DAYS 4131L
#define R7PER1NUM 4132L
#define R7PER2NUM 4133L
#define R7PER3NUM 4134L
#define R7PER1AMT 4135L
#define R7PER2AMT 4136L
#define R7PER3AMT 4137L
#define R8 4138L
#define R8ENABLE 4139L
#define R8DATETIME 4140L
#define R8PRODUCT 4141L
#define R8AMT 4142L
#define R8ACCUM 4143L
#define DT 4144L
#define DT1FROM 4145L
#define DT1TO 4146L
#define DT1TIME 4147L
#define DT2FROM 4148L
#define DT2TO 4149L
#define DT2TIME 4150L
#define DT3FROM 4151L
#define DT3TO 4152L
#define DT3TIME 4153L
#define DT4FROM 4154L
#define DT4TO 4155L
#define DT4TIME 4156L
#define PRODADJ 4157L
