...
//  FILE:         spsmanageraboutdlg.cpp
//  AUTHOR:       Borland
//
//  OVERVIEW
//  ~~~~~~~~
//  Source file for implementation of TSpsManagerAboutDlg (TDialog).
//
//----------------------------------------------------------------------------
...
//{{TSpsManagerAboutDlg Implementation}}
...
//
TSpsManagerAboutDlg::TSpsManagerAboutDlg(TWindow* parent, TResId resId, TModule* module)
:
...
TSpsManagerAboutDlg::~TSpsManagerAboutDlg()
{
  Destroy();
...
void TSpsManagerAboutDlg::SetupWindow()
{
