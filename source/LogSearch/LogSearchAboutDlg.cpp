...
//  FILE:         logsearchaboutdlg.cpp
//  AUTHOR:       Jack Ely
//
//  OVERVIEW
//  ~~~~~~~~
//  Source file for implementation of TLogSearchAboutDlg (TDialog).
//
//----------------------------------------------------------------------------
...
//
DEFINE_RESPONSE_TABLE1(TLogSearchAboutDlg, TDialog)
//{{TLogSearchAboutDlgRSP_TBL_BEGIN}}
  EV_BN_KILLFOCUS(IDOK, BNKillfocus),
//{{TLogSearchAboutDlgRSP_TBL_END}}
END_RESPONSE_TABLE;


//{{TLogSearchAboutDlg Implementation}}
...
//
TLogSearchAboutDlg::TLogSearchAboutDlg(TWindow* parent, TResId resId, TModule* module)
:
...
TLogSearchAboutDlg::~TLogSearchAboutDlg()
{
  Destroy();
...
void TLogSearchAboutDlg::SetupWindow()
{
...
void TLogSearchAboutDlg::CeEditfindnext(TCommandEnabler &tce)
{
 tce.Enable(true);
}


void TLogSearchAboutDlg::CeEditfindprev(TCommandEnabler &tce)
{
 tce.Enable(true);
}


void TLogSearchAboutDlg::BNKillfocus()
{
