...
//  FILE:         netmonaboutdlg.cpp
//  AUTHOR:       Jack H. Ely
//
//  OVERVIEW
//  ~~~~~~~~
//  Source file for implementation of TNetMonAboutDlg (TDialog).
//
//----------------------------------------------------------------------------
...
//{{TNetMonAboutDlg Implementation}}
...
//
TNetMonAboutDlg::TNetMonAboutDlg(TWindow* parent, TResId resId, TModule* module)
:
...
TNetMonAboutDlg::~TNetMonAboutDlg()
{
  Destroy();
...
void TNetMonAboutDlg::SetupWindow()
{
