...
//  unsigned long ulDateFirstApproval;
//  unsigned long ulDateLastApproval;
//  unsigned long ulNumApprovals
//  unsigned long ulAmtApprovals; // Total amount of checks from consumer
...
#if 1
      // MAB072302
      // Signal that no record found for Display Posfile values in VoiceAuth
      LastApproval = 1;
#endif
...
#if 1
 // MAB072302 - Display Posfile values in VoiceAuth
 // Get sums and dates
 LastApproval    = PosFileRecord.LastApproval;
 FirstApproval   = PosFileRecord.FirstApproval;
 NumApprovals    = PosFileRecord.NumApprovals;
 AmountApprovals = PosFileRecord.AmountApprovals;
#endif
...
//  ulDateFirstApproval;
//  ulDateLastApproval;
   ulNumApprovals = NumPosFileOverrides;
   ulAmtApprovals = AmountPosFileOverrides;
#endif
