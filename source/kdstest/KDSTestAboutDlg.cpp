...
//  FILE:         kdstestaboutdlg.cpp
//  AUTHOR:       
//
//  OVERVIEW
//  ~~~~~~~~
//  Source file for implementation of TKDSTestAboutDlg (TDialog).
//
//----------------------------------------------------------------------------
...
//{{TKDSTestAboutDlg Implementation}}
...
//
TKDSTestAboutDlg::TKDSTestAboutDlg(TWindow* parent, TResId resId, TModule* module)
:
...
TKDSTestAboutDlg::~TKDSTestAboutDlg()
{
  Destroy();
...
void TKDSTestAboutDlg::SetupWindow()
{
